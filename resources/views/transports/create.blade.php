...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Ajouter un Transport</h1>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('transports.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="route_description" id="route_description" rows="4" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required>{{ old('route_description') }}</textarea>
