        ...
        <div class="flex items-center space-x-3 sm:space-x-4">
            @auth
                ...
                <div class="hidden md:flex items-center space-x-2">
                    ...
                    <div class="relative">
                        ...
                        <div id="userDropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 border border-gray-100">
                            ...
                            <a href="{{ route('profile.edit') }}#settings" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                ...
                <div class="md:hidden">
                    <form id="logout-form-header" action="{{ route('logout') }}" method="POST" class="inline">
                        @csrf
                        <button type="submit" class="p-2 text-red-600 hover:text-red-800 rounded-full hover:bg-red-50" title="Déconnexion">
            ...
            @else
                ...
                <div class="flex items-center space-x-2 sm:space-x-3">
                    <a href="{{ route('login') }}" class="text-sm px-3 py-1.5 rounded-md text-indigo-600 hover:text-indigo-800 hover:bg-indigo-50 transition-colors flex items-center">
                        <i class="fas fa-sign-in-alt mr-1.5"></i> Connexion
                    </a>
                    <a href="{{ route('register') }}" class="text-sm px-3 py-1.5 rounded-md bg-indigo-600 text-white hover:bg-indigo-700 transition-colors hidden sm:inline-flex items-center">
